        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nome_Nome = table.Column<string>(maxLength: 30, nullable: true),
                    Nome_Sobrenome = table.Column<string>(maxLength: 30, nullable: true),
                    Cpf = table.Column<string>(nullable: false),
                    Endereco_Logradouro = table.Column<string>(maxLength: 30, nullable: true),
                    Endereco_Numero = table.Column<int>(nullable: true),
                    Endereco_CEP = table.Column<string>(maxLength: 8, nullable: true),
                    Endereco_Bairro = table.Column<string>(maxLength: 30, nullable: true),
                    Endereco_Cidade = table.Column<string>(maxLength: 35, nullable: true),
                    Endereco_Estado = table.Column<string>(maxLength: 35, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Autor = table.Column<string>(maxLength: 60, nullable: false),
                    CategoriaId = table.Column<int>(nullable: false),
                    Descricao = table.Column<string>(maxLength: 200, nullable: false),
                    ImagemUrl = table.Column<string>(maxLength: 200, nullable: false),
                    Preco = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantidadeVendidos = table.Column<int>(nullable: false),
